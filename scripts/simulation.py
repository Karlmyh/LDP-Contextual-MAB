...
def run_base_simulation():
    ...
    for epsilon in [1,2,4,8,1024]:
        for epsilon_m in [  1024]:
            for gamma in [ 0]:
                for n in [  10000, 20000, 40000, 60000, 80000, 120000, 160000]:
                    for n_m in [ 0]:
                        for d in [2]: 
                            for M in [2]:
                                for K in [3]:
    ...
    # for epsilon in [8, 4, 2]:
    #     for epsilon_m in [   2, 8,  1024]:
    #         for gamma in [ 0]:
    #             for n in [  20000, 80000, 120000, 160000]:
    #                 for n_m in [ 0,  20000, 80000, 160000]:
    #                     for d in [2]: 
    #                         for M in [2]:
    #                             for K in [2]:
    #                                 for if_weighted in [True, False]:
    #                                     print("epsilon: {}, epsilon_m: {}, gamma: {}, n: {}, n_m: {}, d: {}, M: {}, K: {}, if_weighted: {}".format(epsilon, epsilon_m, gamma, n, n_m, d, M, K, if_weighted))
