...
from bandit import ShiftedExponentialSimulationDistribution, ShiftedSymmetricSimulationDistribution
...
def run_base_auxilary_kappa():
    ...
    #                         for M in [2]:
    #                             for K in [3]:
    #                                 for kappa in [0, 0.2, 0.4, 0.6, 0.8, 1]:
